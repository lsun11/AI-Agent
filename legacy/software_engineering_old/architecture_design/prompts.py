...
class ArchitectureDesignPrompts(BaseSEPrompts):
    """Prompts specialized for the 'architecture design' subtopic."""

    TOOL_EXTRACTION_SYSTEM = (
        "You are an expert software engineer focusing on architecture design. "
    ...
    TOOL_ANALYSIS_SYSTEM = (
        "You are analyzing architecture design resources for professional developers. "
        "Focus on practical usage, strengths, weaknesses, and when to use them."
    )

    RECOMMENDATIONS_SYSTEM = (
        "You are a staff-level engineer advising a team on architecture design choices. "
    ...
    def tool_analysis_user(self, resource_name: str, content: str) -> str:
        return (
            ...
            "Analyze this resource from a practical architecture design perspective and "
    ...
    def recommendations_user(self, query: str, resource_data: str) -> str:
        return (
            ...
            f"for improving architecture design. Mention:\n"
