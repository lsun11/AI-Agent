...
class ProjectManagementPrompts(BaseSEPrompts):
    """Prompts specialized for the 'project management' subtopic."""

    TOOL_EXTRACTION_SYSTEM = (
        "You are an expert software engineer focusing on project management. "
    ...
    TOOL_ANALYSIS_SYSTEM = (
        "You are analyzing project management resources for professional developers. "
        "Focus on practical usage, strengths, weaknesses, and when to use them."
    )

    RECOMMENDATIONS_SYSTEM = (
        "You are a staff-level engineer advising a team on project management choices. "
    ...
    def tool_analysis_user(self, resource_name: str, content: str) -> str:
        return (
            ...
            "Analyze this resource from a practical project management perspective and "
    ...
    def recommendations_user(self, query: str, resource_data: str) -> str:
        return (
            ...
            f"for improving project management. Mention:\n"
