...
class CodeQualityPrompts(BaseSEPrompts):
    """Prompts specialized for the 'code quality' subtopic."""

    TOOL_EXTRACTION_SYSTEM = (
        "You are an expert software engineer focusing on code quality. "
    ...
    TOOL_ANALYSIS_SYSTEM = (
        "You are analyzing code quality resources for professional developers. "
        "Focus on practical usage, strengths, weaknesses, and when to use them."
    )

    RECOMMENDATIONS_SYSTEM = (
        "You are a staff-level engineer advising a team on code quality choices. "
    ...
    def tool_analysis_user(self, resource_name: str, content: str) -> str:
        return (
            ...
            "Analyze this resource from a practical code quality perspective and "
    ...
    def recommendations_user(self, query: str, resource_data: str) -> str:
        return (
            ...
            f"for improving code quality. Mention:\n"
