...
class CodeReviewPrompts(BaseSEPrompts):
    """Prompts specialized for the 'code review' subtopic."""

    TOOL_EXTRACTION_SYSTEM = (
        "You are an expert software engineer focusing on code review. "
    ...
    TOOL_ANALYSIS_SYSTEM = (
        "You are analyzing code review resources for professional developers. "
        "Focus on practical usage, strengths, weaknesses, and when to use them."
    )

    RECOMMENDATIONS_SYSTEM = (
        "You are a staff-level engineer advising a team on code review choices. "
    ...
    def tool_analysis_user(self, resource_name: str, content: str) -> str:
        return (
            ...
            "Analyze this resource from a practical code review perspective and "
    ...
    def recommendations_user(self, query: str, resource_data: str) -> str:
        return (
            ...
            f"for improving code review. Mention:\n"
