# from abc import ABC
# from .base_models import BaseSoftwareEngRecommendation
#
#
# class BaseSoftwareEngPrompts(ABC):
#     """Base prompt set for software-engineering research topics.
#
#     Subclasses can override the SYSTEM strings and user message builders
#     to specialize for a particular subtopic (architecture, testing, etc.).
#     """
#
#     TOOL_EXTRACTION_SYSTEM: str = (
#         "You are a senior software engineer and researcher.\n"
#         "Given some articles or documentation, extract the most important\n"
#         "concepts, techniques, and tools that a developer should know about\n"
#         "for this topic."
#     )
#
#     TOOL_ANALYSIS_SYSTEM: str = (
#         "You are analyzing software-engineering resources. Focus on extracting\n"
#         "key practices, patterns, trade-offs, and any tools that developers\n"
#         "can apply in real projects."
#     )
#
#     RECOMMENDATIONS_SYSTEM: str = (
#         "You are a staff-level engineer mentoring a developer. Based on the\n"
#         "collected information, provide concise, actionable recommendations."
#     )
#
#     COMPATIBILITY_NOTE: str = (
#         "It inherits the generic structure from BaseSoftwareEngPrompts and is\n"
#         "fully compatible with the agent's expectations.\n\n"
...
#             "Query: {query}\n\n"
#             "Content:\n{content_snippet}\n\n"
#             "Extract a concise list of 5-10 key concepts, techniques, or tools\n"
#             "that are most relevant for this query. Return only one item per line\n"
...
#             "Topic: {topic}\n\n"
#             "Content:\n{content_snippet}\n\n"
#             "Analyze this content for a practicing software engineer and provide:\n"
#             "- summary: a 2-3 sentence summary of the core idea\n"
#             "- best_practices: bullet list of concrete best practices\n"
#             "- pitfalls: bullet list of common mistakes or risks\n"
#             "- suggested_action_plan: bullet list of next steps for the developer\n"
...
#             "Aggregated Resource Data (JSON-like):\n{resources}\n\n"
#             "Provide a short recommendation (3-6 sentences) for the developer:\n"
#             "- summarize the best approach or pattern\n"
#             "- highlight 3-5 concrete best practices\n"
#             "- warn about the main pitfalls\n"
#             "- outline a simple action plan they can follow this week."
#         ).format(query=query, resources=serialized_resources[:4000])
# src/topics/software_eng/base_prompts.py
