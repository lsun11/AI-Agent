...
#     """
#     Generic analysis schema for career-related platforms/tools.
#     Kept structurally similar to the CS analysis model so shared
#     formatting code can work across domains.
#     """
#     pricing_model: str = "Unknown"   # e.g. Free, Freemium, Paid, Enterprise, Unknown
#     pricing_details: Optional[str] = None  # e.g. "from $20/month", "Free tier + $10/user/month"
#
#     # Keep CS-style fields for compatibility, reinterpret meaning per subtopic
#     is_open_source: Optional[bool] = None
#     tech_stack: List[str] = []               # For many career tools, this may be empty or just "Web", "Mobile app"
#     description: str = ""
#     api_available: Optional[bool] = None
#     language_support: List[str] = []
#     integration_capabilities: List[str] = []
#
#     # Career-specific generic fields
#     target_roles: List[str] = []             # e.g. "Software Engineer", "Data Scientist"
#     seniority_focus: Optional[str] = None    # e.g. "Entry-level", "Mid-level", "Senior"
#
#
# class CareerBaseCompanyInfo(BaseModel):
#     """
#     Generic info about a career-related platform/tool.
#     Structurally compatible with your DeveloperToolCompanyInfo.
#     """
#     name: str
#     description: str
#     website: str
...
#     """
#     query: str
#     extracted_tools: List[str] = []  # e.g. platform/tool/resource names
#     companies: List[CareerBaseCompanyInfo] = []
