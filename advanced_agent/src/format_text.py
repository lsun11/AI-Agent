...
#     tradeoffs: List[str] = data.get("tradeoffs") or []
...
#     """
#     Fallback that mirrors your old 'summary / best_practices / pitfalls / action_plan' formatting.
#     """
#     lines: List[str] = []
#
...
#
#     - If analysis is a JSON string (like your example), parse and pretty-print.
#     - If it's a Pydantic model or dict, format by shape.
#     - If it's plain text, return as-is.
#     """
#     # Case A: string → try JSON first, otherwise keep as text
...
#         except Exception:
#             print("^^^^^^^^^^^^^^^^^^^^^", data)
#             # Not JSON, just plain text analysis → keep old behavior
#             return analysis
#     else:
...
#
#     # Fallback: your previous summary/best_practices/pitfalls/action_plan layout
